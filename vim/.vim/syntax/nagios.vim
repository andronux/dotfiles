...
syn match nagiosMacro  '\$HOST\(NAME\|ALIAS\|ADDRESS\|STATE\|OUTPUT\|PERFDATA\|STATETYPE\|EXECUTIONTIME\|STATEID\)\$'
syn match nagiosMacro  '\$\(ARG\|USER\)\([1-9]\|[1-2][0-9]\|3[0-2]\)\$'
syn match nagiosMacro  '\$SERVICE\(DESC\|STATE\|OUTPUT\|PERFDATA\|LATENCY\|EXECUTIONTIME\|STATETYPE\|STATEID\)\$'
...
syn keyword nagiosDirective contained host_notification_period hostgroup_members hostgroup_name servicegroup_name hostgroups servicegroups
syn keyword nagiosDirective contained is_volatile last_notification
syn keyword nagiosDirective contained low_flap_threshold max_check_attempts first_notification_delay
...
syn keyword nagiosDirective contained notification_period notifications_enabled host_notifications_enabled service_notifications_enabled
